			...
			<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/Product/updateProduct" enctype="multipart/form-data">
				<table>
					...
					<tr>
						...
						<td><input type="TEXT" class="line" name="product_inventory" size="45"
					...
					<tr>
						...
						<td>
							<label for="customization">
								<input type="radio" class="" id="cz" name="customization" size="45"
					...
					<tr>
						...
						<td><input type="TEXT" class="line" name="customer_product_price" size="45"
					...
					<tr>
						...
						<td>
							<label for="product_status">
								<input type="radio" class="" name="product_status" size="45"
				...
				<input type="submit" class="btn_sub" value="送出修改">
			</FORM>
			<button type="button" onclick="location.href='./listAllProduct_test.jsp';">取消修改</button>
		</div>
		<div class="preview">
			<h3>商品預覽</h3>
			<img src="data:image/png;base64,<%= Base64.getEncoder().encodeToString(productVO.getProductImage()) %>" width="400px" height="100%"/>
		</div>
	</main>
</body>
